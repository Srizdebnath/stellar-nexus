...
export interface Client {
   ...
   */
  generate_hash: ({text}: {text: string}, options?: MethodOptions) => Promise<AssembledTransaction<Array<string>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAHZXhlY3V0ZQAAAAABAAAAAAAAAAR0ZXh0AAAAEAAAAAEAAAPqAAAAEA==",
        ...
        "AAAAAAAAAAAAAAANZ2VuZXJhdGVfaGFzaAAAAAAAAAEAAAAAAAAABHRleHQAAAAQAAAAAQAAA+oAAAAQ" ]),
      options
    )
  }
  public readonly fromJSON = {
    execute: this.txFromJSON<Array<string>>,
        ...
        generate_hash: this.txFromJSON<Array<string>>
  }
}